	...
	<table class="table table-striped">
		<thead>
			<tr>
				...
				<th><?php echo JHtml::_('grid.sort', 'TASKMAN_TASKS_NOTES', 'notes', $listDirn, $listOrder); ?>

				</th>
				<th><?php echo JHtml::_('grid.sort', 'TASKMAN_TASKS_ASIGNEE', 'asignee', $listDirn, $listOrder); ?>

				</th>
				<th><?php echo JHtml::_('grid.sort', 'TASKMAN_TASKS_PROJECTS', 'projects', $listDirn, $listOrder); ?>

				</th>
				<th><?php echo JHtml::_('grid.sort', 'TASKMAN_TASKS_SUBTASKS', 'subtasks', $listDirn, $listOrder); ?>

				</th>
				<th><?php echo JHtml::_('grid.sort', 'TASKMAN_TASKS_COMMENTS', 'comments', $listDirn, $listOrder); ?>


				</th>
				<th><?php echo JHtml::_('grid.sort', 'TASKMAN_TASKS_DUEDATE', 'duedate', $listDirn, $listOrder); ?>

				</th>

				<th><?php echo JHtml::_('grid.sort', 'TASKMAN_TASKS_TAGS', 'tags', $listDirn, $listOrder); ?>

				</th>
				<th><?php echo JHtml::_('grid.sort', 'TASKMAN_TASKS_FILE', 'file', $listDirn, $listOrder); ?>

				</th>
				<th><?php echo JHtml::_('grid.sort', 'TASKMAN_TASKS_FOLLOWERS', 'followers', $listDirn, $listOrder); ?>

				</th>
				<th><?php echo JHtml::_('grid.sort', 'TASKMAN_TASKS_FOLLOW', 'follow', $listDirn, $listOrder); ?>

				</th>
				<th><?php echo JHtml::_('grid.sort', 'TASKMAN_TASKS_FEED', 'feed', $listDirn, $listOrder); ?>
