...
<form	action="<?php echo JRoute::_('index.php?option=com_taskman&view=labels'); ?>" 	
	...
	<table class="table table-striped">
		<thead>
			<tr>
				<th width="5">
					...
					<?php echo JHtml::_('grid.sort', 'TASKMAN_LABEL_ID', 'label_id', $listDirn, $listOrder); ?>
				</th>
				...
				<th><?php echo JHtml::_('grid.sort', 'TASKMAN_LABEL_NAME', 'label_name', $listDirn, $listOrder); ?>
				</th>
		...
		<tbody>
			...
			<tr class="row<?php echo $i % 2; ?>">
				<td><?php echo $item->label_id; ?>
				</td>
				<td><?php echo JHtml::_('grid.id', $i, $item->label_id); ?>
				</td>

				<td><?php echo $item->label_name; ?>
				</td>
