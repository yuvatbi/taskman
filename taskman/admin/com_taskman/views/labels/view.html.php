...
class TaskManViewLabels extends JViewLegacy
{
          ...
          //JToolBarHelper::title($isNew ? JText::_('COM_HELLOWORLD_MANAGER_HELLOWORLD_NEW')
           //                                  : JText::_('COM_HELLOWORLD_MANAGER_HELLOWORLD_EDIT'));
               ...
               JToolBarHelper::editList('label.edit');
                JToolBarHelper::deleteList('','label.delete');
                 JToolBarHelper::publish('label.publish', 'JTOOLBAR_PUBLISH', true);
		...
		JHtmlSidebar::setAction('index.php?option=com_taskman&view=labels');
